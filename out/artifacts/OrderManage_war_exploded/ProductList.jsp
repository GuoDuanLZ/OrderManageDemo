...
<header class="am-topbar admin-header">
    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav ">
            ...
            <li  class="am-active"><a href="/ProductListServlet">商品管理</a></li>
...
<div class=" admin-content">
    <div class="admin-biaogelist">
        ...
        <div class="listbiaoti am-cf">
            ...
            <dl>
                <button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" onclick="javascript:window.location.href='ProductAdd.jsp' ">添加商品</button>
            </dl>
        </div>
        ...
        <form class="am-form am-g">
            <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
                ...
                <tr class="am-success">
                    ...
                    <th class="table-author am-hide-sm-only">商品产地</th>
                    <th class="table-date am-hide-sm-only">制造商名称</th>
                        ...
                        <td>
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary am-round" onclick="javascript:window.location.href='ProductEdit.jsp'" title="修改订单"><span class="am-icon-pencil-square-o"></span></button>
                                    <button type="button" onclick="javascript:window.location.href='/ProductListServlet'" class="am-btn am-btn-default am-btn-xs am-text-danger am-round" title="删除订单"><span class="am-icon-trash-o" ></span></button>
                                </div>
                            </div>
                        </td>
