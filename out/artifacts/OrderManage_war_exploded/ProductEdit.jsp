    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            ...
            <div class="listbiaoti am-cf">
                ...
                <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">修改商品</a></dl>


            </div>

            <div class="fbneirong">
                <form class="am-form" action="/ProductListServlet">
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品名称：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" id="pname" value="商品一">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品数量：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" id="pnum" value="20">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品型号：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" id="type" value="型号一">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品产地：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" id="place" value="山东">
                        </div>
                    ...
                    <div class="am-form-group am-cf">
                        ...
                        <div class="you">
                            <input type="text" class="am-input-sm" id="mid" placeholder="1" value="2">
                        </div>
