    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            ...
            <div class="listbiaoti am-cf">
                ...
                <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">新增订单</a></dl>

            </div>

            <div class="fbneirong">
                <form class="am-form" method="post" action="/OrderList.jsp">
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品号：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="pid" placeholder="请输入商品号">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品名称：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="pname" placeholder="请输入商品名称">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品总价：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="oprice" placeholder="请输入商品总价">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">客户号：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="cid" placeholder="请输入客户号">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                    ...
                    <div class="am-form-group am-cf">
                        <div class="zuo">员工号：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="eid" placeholder="请输入员工号">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">员工姓名：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="ename" placeholder="请输入员工姓名">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">是否发货：</div>
                        <div class="you">
                            <select data-am-selected name="ostate">
