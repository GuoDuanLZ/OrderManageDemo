...
<header class="am-topbar admin-header">
    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav ">
            ...
            <li  class="am-active"><a href="/ManufactureList">供应商管理</a> </li>
...
<div class="am-cf admin-main">
    ...
    <div class="nav-navicon admin-main admin-sidebar">
        ...
        <div class="sideMenu">
            ...
            <h3 class="am-icon-flag on"><em></em> <a href="#">供应商管理</a></h3>
            <ul>
...
<div class=" admin-content">
    <div class="admin-biaogelist">
        ...
        <div class="listbiaoti am-cf">
            <ul class="am-icon-flag"> 供应商列表</ul>

            <dl class="am-icon-home" style="float: right;">当前位置： 首页 > <a href="#">供应商列表</a></dl>

            <dl>
                <button type="button" onclick="javascript:window.location.href='ManufactureAdd.jsp' " class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" >添加供应商</button>
            </dl>
        </div>
        ...
        <form class="am-form am-g">
            <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
                ...
                <tr class="am-success">
                    ...
                    <th class="table-type">供应商负责人</th>
                    <th class="table-author am-hide-sm-only">供应商联系方式</th>

                    <th width="130px" class="table-set">操作</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${manufactures}" var="manufacture" varStatus="vs">
                <tr>

                        <td>${manufacture.mid}</td>
                        <td>${manufacture.mname}</td>
                        <td>${manufacture.mleader}</td>
                        <td>${manufacture.mphone}</td>
                        <td>
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    ...
                                    <button onclick="javascript:window.location.href='/ManufactureList' " class="am-btn am-btn-default am-btn-xs am-text-danger am-round" title="删除订单"><span class="am-icon-trash-o" ></span></button>
                                </div>
                            </div>
                        </td>
