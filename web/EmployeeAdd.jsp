...
<header class="am-topbar admin-header">
    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav ">
            ...
            <li class="am-active"><a href="/EmployeeListServlet">员工管理</a> </li>
        </ul>
    </div>
</header>
...
<div class="am-cf admin-main">
    ...
    <div class="nav-navicon admin-main admin-sidebar">
        ...
        <div class="sideMenu">
            ...
            <h3 class="am-icon-volume-up on"><em></em> <a href="#">员工管理</a></h3>
            <ul>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            ...
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on"> 新增员工</ul>

                <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">新增员工

            </div>

            <div class="fbneirong">
                <form class="am-form" method="post" action="/EmployeeAddServlet">
                    ...
                    <div class="am-form-group am-cf">
                        <div class="zuo">员工性别：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="esex" placeholder="请输入员工性别">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">联系电话：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="ephone" placeholder="请输入联系电话">
                        </div>
                    </div>
