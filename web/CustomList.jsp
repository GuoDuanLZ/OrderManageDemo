...
<div class=" admin-content">
    <div class="admin-biaogelist">
        ...
        <div class="listbiaoti am-cf">
            <ul class="am-icon-flag"> 客户列表</ul>

            <dl class="am-icon-home" style="float: right;">当前位置： 首页 > <a href="#">客户列表</a></dl>

            <dl>
                <button type="button" onclick="javascript:window.location.href='CustomAdd.jsp' " class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" >添加客户</button>
            </dl>
        </div>
        ...
        <form class="am-form am-g">
            <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
                ...
                <tr class="am-success">
                    ...
                    <th class="table-type">客户邮箱</th>
                    <th class="table-author am-hide-sm-only">客户手机号</th>
