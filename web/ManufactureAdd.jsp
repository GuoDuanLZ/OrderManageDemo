    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            ...
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on"> 新增供应商</ul>

                <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">新增供应商</a></dl>


            </div>

            <div class="fbneirong">
                <form class="am-form" method="post" action="/ManufactureAdd">
                    <div class="am-form-group am-cf">
                        <div class="zuo">供应商名称：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="mname" placeholder="请输入供应商名称">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">负责人：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="mleader" placeholder="请输入负责人姓名">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">联系电话：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="mphone" placeholder="请输入联系电话">
                        </div>
                    </div>
