    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            ...
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on"> 新增商品</ul>

                <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">新增商品</a></dl>
            ...
            <div class="fbneirong">
                <form class="am-form" action="/ProductAddServlet" method="post">
                    ...
                    <div class="am-form-group am-cf">
                        ...
                        <div class="you">
                            <input type="text" class="am-input-sm" name="pnum" placeholder="请输入商品数量">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品价格：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="price" placeholder="请输入商品价格">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品型号：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="type" placeholder="请输入商品型号">
                        </div>
                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">商品产地：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="place" placeholder="请输入商品产地">
                        </div>

                    </div>
                    <div class="am-form-group am-cf">
                        <div class="zuo">制造商编号：</div>
                        <div class="you">
                            <input type="text" class="am-input-sm" name="mid" placeholder="请输入制造商编号">
                        </div>
